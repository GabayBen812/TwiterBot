...
# Command line: python twitter_kucoin_futures.py l (save trade logs) p (print query intervals) 2 (2nd set of twitter keys)
...
# Users to track
print('\nUsers: e.g. "coinbase,CoinbasePro,kucoin" or "all" from: '+'%s '* len(exchange_keywords) % tuple(list(exchange_keywords.keys())))
usernames = input()
skip_input = False
if not usernames:
